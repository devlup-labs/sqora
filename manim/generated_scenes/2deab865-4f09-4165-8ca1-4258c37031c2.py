...
class GeneratedScene(Scene):
    def construct(self):
        ...
        condition_math = MathTex("a \\approx \\lambda", font_size=48, color=BLUE_C)
        ...
        minima_math = MathTex("a \\sin \\theta = n \\lambda", font_size=44, color=RED_C)
        ...
        final_formula = MathTex("W = \\frac{2 \\lambda D}{a}", font_size=48, color=BLUE_C)
