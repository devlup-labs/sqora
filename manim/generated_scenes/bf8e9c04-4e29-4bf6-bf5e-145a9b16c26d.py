...
class GeneratedScene(Scene):
    def construct(self):
        ...
        formula_main = MathTex("F = qE", font_size=72, color=BLUE_C)
        ...
        accel_eq = MathTex("qE = ma", font_size=48)
        accel_res = MathTex("a = \\frac{qE}{m}", font_size=60, color=BLUE_C)
        ...
        eq_math = MathTex("T \\sin \\theta = qE", font_size=36)
        
        work_text = Text("Work done moving a charge:", font_size=28, width=config.frame_width - 2)
        work_math = MathTex("W = (qE) \\cdot d", font_size=36)
