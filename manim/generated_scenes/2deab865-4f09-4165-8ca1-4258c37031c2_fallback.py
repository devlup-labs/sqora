...
class GeneratedScene(Scene):
    def construct(self):
        ...
        body_5 = Text("of the obstacle or slit ($a$) must be comparable to the wavelength of the light ($\\lambda$). Why we don’t see light", font_size=28, color=GREY_A, width=config.frame_width - 2)
